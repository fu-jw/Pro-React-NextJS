        ...
        if (customerDetails.email) {
          ...
          for (const item of lineItems) {
            ...
            if (isSubscription) {
              ...
              // The upsert operation in Prisma is a combination of update and insert.
              // It allows you to update an existing record if it exists or create a new one if it doesn't.
